...
const CoursesTab = () => {
    ...
    const [unpublishingCourse, setUnpublishingCourse] = useState<CourseDto | null>(null);
                ...
                <Col key={mod.moderatorId} xs={24} sm={12} lg={8}>
                    <Card style={{ borderRadius: 10 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                            <div style={{ width: 40, height: 40, borderRadius: "50%", background: "linear-gradient(135deg, #1890ff, #096dd9)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        ...
                        <Row gutter={8}>
                            <Col span={12}><Statistic title="Проверяет сейчас" value={mod.currentlyReviewing} valueStyle={{ fontSize: 20, color: mod.currentlyReviewing > 0 ? "#faad14" : "#666" }} /></Col>
                            <Col span={12}><Statistic title="Всего проверено" value={mod.totalReviewed} valueStyle={{ fontSize: 20 }} /></Col>
                            <Col span={12} style={{ marginTop: 8 }}><Statistic title="Одобрено" value={mod.totalApproved} valueStyle={{ fontSize: 20, color: "#52c41a" }} /></Col>
                            <Col span={12} style={{ marginTop: 8 }}><Statistic title="Отклонено" value={mod.totalRejected} valueStyle={{ fontSize: 20, color: "#ff4d4f" }} /></Col>
                        </Row>
                    </Card>
                </Col>
            ))}
