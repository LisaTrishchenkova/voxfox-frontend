...
const CourseDetailPage = () => {
  ...
  return (
    <>
      ...
      <div
        style={{ backgroundColor: "rgba(0,100,0,0.1)", padding: "60px 80px" }}
      >
            ...
            >
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <Text>
                    Рейтинг: <strong>{cource.rating.toFixed(1)}</strong>
                  </Text>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <TeamOutlined style={{ color: "#1677ff", fontSize: 16 }} />
                  <Text>
                    Студентов: <strong>{cource.enrollmentCount}</strong>
                  </Text>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <ClockCircleOutlined
                  ...
                  />
                  <Text>
                    Длительность: <strong>{cource.durationMinutes} мин</strong>
                  </Text>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <BookOutlined style={{ fontSize: 16 }} />
                  <Text>
                    Автор: <strong>{cource.author?.name}</strong>
                  </Text>
                </div>
                {cource.publishedAt && (
                  <div
                  ...
                  >
                    <Text type="secondary">
                      Опубликован:{" "}
                      {new Date(cource.publishedAt).toLocaleDateString(
                        "ru-RU",
                        {
                          day: "numeric",
                          month: "long",
