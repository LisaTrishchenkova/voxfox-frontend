  ...
  const courses: Course[] = [
    {
      ...
      description: 'Изучите основы React, создайте свое первое приложение и поймите основные концепции.',
    ...
    },
    {
      ...
      description: 'Освойте TypeScript для создания надежных и масштабируемых приложений.',
      category: 'Программирование',
      level: 'intermediate',
      status: 'draft',
      students: 0,
    ...
    },
    {
      id: '3',
      title: 'UI/UX дизайн',
      description: 'Создание красивых и удобных интерфейсов для веб и мобильных приложений.',
      category: 'Дизайн',
      level: 'beginner',
      status: 'published',
      students: 156,
                  ...
                  <Card
                    ...
                    cover={
                      <div style={{
                        ...
                        <BookOutlined style={{ 
                          fontSize: '48px', 
                          color: course.status === 'published' ? '#52c41a' : '#fa8c16' 
                        }} />
                      </div>
                    }
                    actions={[
                    ...
                    <div style={{ 
                      ...
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ 
                          ...
                          <PlayCircleOutlined style={{ color: '#595959', fontSize: '14px' }} />
                          <Text style={{ fontSize: '14px', fontWeight: 500 }}>
                            {course.lessonsCount}
                          </Text>
                        </div>
                        <Text type="secondary" style={{ fontSize: '12px' }}>уроков</Text>
                      </div>
                      ...
                      <div style={{ textAlign: 'center' }}>
                        ...
                        <Text type="secondary" style={{ fontSize: '12px' }}>длительность</Text>
                      </div>
                      ...
                      <div style={{ textAlign: 'center' }}>
                        ...
                        <Text type="secondary" style={{ fontSize: '12px' }}>студентов</Text>
                      </div>
                    </div>
                  </Card>
                </Col>
